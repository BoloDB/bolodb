      ...
      },
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "BoloDB works with PostgreSQL, MySQL, Oracle, SQL Server, SQLite, Snowflake, Databricks, BigQuery, DuckDB, and any SQL database via a connection string."
            }
          },
          {
            "@type": "Question",
...
<svelte:head>
  ...
  <meta name="keywords" content="text to sql, natural language to SQL, AI SQL assistant, ask your database, database chatbot, PostgreSQL AI, MySQL AI, Oracle AI, SQL Server AI, Snowflake AI, Databricks AI, BigQuery AI, DuckDB AI, no-code data analytics, self-hosted text-to-SQL, open source SQL AI, OpenRouter, business intelligence AI, data analyst AI, plain English to SQL" />
  ...
  <meta property="og:description" content="BoloDB is the AI data analyst you can trust. Ask questions in plain English and get verified, SQL-backed answers from PostgreSQL, MySQL, Oracle, SQL Server, SQLite, Snowflake, Databricks, BigQuery or DuckDB — read-only, no code required." />
  ...
  <meta name="twitter:description" content="BoloDB is the AI data analyst you can trust. Ask questions in plain English and get verified, SQL-backed answers from PostgreSQL, MySQL, Oracle, SQL Server, SQLite, Snowflake, Databricks, BigQuery or DuckDB — read-only, no code required." />
