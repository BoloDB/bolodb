...
async def query(
    ...
    if out.get("answered") and out.get("sql"):
        ...
        # ⚡ Bolt: Using BackgroundTasks for fire-and-forget I/O (like logging) instead of awaiting
        # run_in_threadpool prevents blocking the API response cycle, reducing endpoint latency.
        background_tasks.add_task(
            _save_query_background,
            user_id=user_token["user_id"],
